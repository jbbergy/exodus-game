...
<template>
  <div v-if="character" class="tribute-screen">
    <div class="tribute-card">
      ...
      <p v-if="uiStore.deceasedCause === 'exploration'">a disparu en exploration, parti(e) chercher des ressources.</p>
      <p v-else-if="character.sick">a succombé à la maladie, faute d'avoir trouvé un remède à temps.</p>
